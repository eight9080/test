...
public class TreeInorderPreorderTest {
    @Test
    public void buildTree() throws Exception {

        TreeInorderPreorder t = new TreeInorderPreorder();
        TreeNode treeNode = t.buildTree(
                new int[]{1, 2, 4, 5, 3, 7, 6, 8},
                new int[]{4, 2, 5, 1, 6, 7, 3, 8});
